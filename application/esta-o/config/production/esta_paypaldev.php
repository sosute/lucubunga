...
$config['paypal_hidden_business']      = '9HDGSC4BMMYKC';
...
$config['paypal_hidden_notify_url']    = 'http://'.$_SERVER['HTTP_HOST'].'/dev/notify/index.html';

// for validation of notification
$config['paypal_api_url_webscr']       = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
$config['paypal_param_receiver_email'] = 'info-facilitator@esta-center.com';
