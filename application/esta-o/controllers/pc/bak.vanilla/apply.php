...
class Apply extends CI_Controller {
	...
	private function _load_view_input()
	{
		...
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/input', $data_contents, TRUE);
		$data_frame = array();
	...
	private function _load_view_confirm()
	{
		...
		$data_contents['param_metas'] = $this->config->item('param_metas');
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/confirm', $data_contents, TRUE);
		$data_frame = array();
		$data_frame['contents'] = $contents;
		$this->load->view('pc/frame/main', $data_frame);
	}
	...
	private function _load_view_pay($app_values)
	{
		...
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/pay', $data_contents, TRUE);
		$data_frame = array();
		$data_frame['contents'] = $contents;
		$this->load->view('pc/frame/main', $data_frame);
	}
	...
	private function _load_view_diff($app_values)
	{
		...
		$data_contents = $app_values;
		$data_contents['param_metas'] = $this->config->item('param_metas');
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/diff', $data_contents, TRUE);
		$data_frame = array();
		$data_frame['contents'] = $contents;
		$this->load->view('pc/frame/main', $data_frame);
	}
	...
	private function _load_view_match($app_values)
	{
		...
		$data_contents = $app_values;
		$data_contents['param_metas'] = $this->config->item('param_metas');
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/match', $data_contents, TRUE);
		$data_frame = array();
		$data_frame['contents'] = $contents;
		$this->load->view('pc/frame/main', $data_frame);
	}
	...
	{
		$data_contents = array();
		$contents = $this->load->view('pc/contents/'.self::PAGE_ID.'/done', $data_contents, TRUE);
		$data_frame = array();
		$data_frame['contents'] = $contents;
		$this->load->view('pc/frame/main', $data_frame);
	}
