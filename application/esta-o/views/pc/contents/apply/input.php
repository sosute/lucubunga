...
米国国土安全保障省申請料 (14$) + 申請代行サービス料 = <?php echo number_format($this->config->item('paypal_base_fee'));?>円 (税込<?php echo number_format($this->config->item('paypal_hidden_subtotal'));?>円)
