...
<div class="f_right">は必須入力項目です。</div>
</div>
<!--
<div class="f_box">
<div class="f_center2"><span class="f_option">任意</span></div>
<div class="f_right">は任意入力項目です。未選択や空欄でも構いません。</div>
</div>
-->
<div class="f_box">
<div class="f_center2"><div class="f_hint">？</div></div>
<div class="f_right">を押すと質問事項の詳細な説明をご確認頂けます。</div>
</div>
</div>
...
if (
	...
	/*
	$id = 'no_check_passport';
	$checked = ($this->input->post('no_check_passport') === 'true') ? 'checked' : '';
	$element = form_checkbox(array(
		'name' => $id,
		'id' => $id,
		'value' => set_value($id, 'fa'),
		'checked' => $checked,
	)).'<label for="'.$id.'">該当する</label>'."\n";
	echo output_html_f_box($id, $element, form_error($id), $param_metas);
	*/
} else {
...
<td class="td_apply2_02">
<p>質問5：
自らあるいは他者が米国査証を入手したり米国に入国したりするために、これまで詐欺を行ったり、自身あるいは他者を偽ったりしたことがありますか？</p>
</td>
</tr>
<tr>
<td class="td_apply2_01">
...
<?php echo form_radio('q8', 'Yes', $selected); ?>Yes
<?php $selected = ($this->input->post('q8') !== 'Yes') ? TRUE : FALSE; ?>
<?php echo form_radio('q8', 'No', $selected); ?>No
</div>
</td>
<td class="td_apply2_02">
<p>質問8：
...
<p>申請書のご入力及びご確認後の決済項にて上記申請料の決済をお願い致します。<br />
当社が定める申請料には、米国国土安全保障省および旅行促進法により定められた14$が含まれています。<br />
これらの支払いは各種クレジットカードおよびPayPalでの決済が可能です。</p>
<p>お客様からのサービスの進行の要請とお支払いが確認できた時点からサービスが進行されます。</p>
<p>当社サービスでは、お客様に代わりESTA申請手続きを行います。</p>
