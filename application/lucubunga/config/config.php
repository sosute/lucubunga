...
if (
	...
	$_SERVER['REQUEST_URI'] !== '' &&
	preg_match('/^\/dev\//', $_SERVER['REQUEST_URI'])
)
{
	$env = 'dev';
}
...
|
*/
$config['encryption_key'] = '224a6f78632296758c669dsadosuag4c4a9';
...
$config['sess_cookie_name']     = 'lucubunga';
